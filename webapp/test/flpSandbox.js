		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OPA Tests",
									"targetURL": "#student6820comsaptrainingux402opaux402opa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student6820comsaptrainingux402opaux402opa-display": {
								"semanticObject": "student6820comsaptrainingux402opaux402opa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student6820.com.sap.training.ux402.opa.ux402opa",
									"url": sap.ui.require.toUrl("student6820/com/sap/training/ux402/opa/ux402opa")
								}
							}
						}
					}
